...
from wikilegis.core.api import BillListAPI, SegmentsListAPI, CommentListAPI, api_root, UserUpdateAPI
...
urlpatterns = [
    ...
    url(r'^bill/(?P<bill_id>\d+)/proposal/$', CreateProposal.as_view(), name='create_proposal'),
    url(r'^bill/(?P<bill_id>\d+)/proposal/(?P<segment_id>\d+)/$', 'wikilegis.core.views.show_proposal', name='show_proposal'),
    ...
    url(r'^acompanhamento/$', TemplateView.as_view(template_name='acompanhamento.html'), name='acompanhamento'),
    url(r'^bill/(?P<pk>\d+)/report/$', BillReport.as_view(), name='bill_report'),
    url(r'^upvote/(?P<content_type>\d+)/(?P<object_id>\d+)/$', 'wikilegis.core.views.upvote', name='upvote'),
    url(r'^downvote/(?P<content_type>\d+)/(?P<object_id>\d+)/$', 'wikilegis.core.views.downvote', name='downvote'),
]
...
urlpatterns += [
    ...
    url(r'^api/user/update/$', UserUpdateAPI.as_view(), name='user_update_api'),
]